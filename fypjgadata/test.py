...
#IMPORTANT NOTE THE KEY CLIENT ID AND CLIENT SECRET FROM GOOGLE DEVELOPER CONSOLE WILL EXPIRE IN AROUND 1 WEEK, IF FACE AN ERROR RUNNING THE
#PROGRAM NEED TO CREATE A NEW KEY AT GOOGLE DEVELOPER CONSOLE. THIS IS ONE OF THE MOST COMMON ISSUE FOR THIS PROGRAM oauth2client.client.HttpAccessTokenRefreshError: invalid_grant: Token has been expired or revoked.
#the client id and client secret has expired for this need to create new ones
...
client_id = '441368425349-j8j7ad5g45sn2tlqctdru16nr1kpisnd.apps.googleusercontent.com'
client_secret = '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'
...
#RUN THIS FROM LINE 1 TO 41 FIRST THE BELOW ONE WAIT UNTIL YOU HAVE COMPLETED THE AUTHENTICATION PROCESS THEN ADD THE CODES BELOW TO CONNECT TO GOOGLE ANALYTICS
       ...
       try:
         ...
         try:
            ...
            print("data extraction is successfully completed")
             #SAVE AND EXPORT THE DATA EXTRACTED FROM GOOGLE ANALYTICS INTO CSV FILE
            file_name = "test.csv"
            data.to_csv(file_name)
            print("It is exported successfully")
...
#IMPORT TODAY DATE IF YOU WANT THE DATA TO BE UNTIL TODAY
from datetime import date
today= date.today()

#FIND THE VIEW ID FROM GOOGLE ANALYTICS
viewID='255049875'
#NOTE: DIMENSION CAN ONLY HAVE ONE BUT METRICS CAN HAVE MORE THAN ONE FOR THIS NEED TO REFER TO GOOGLE ANALYTICS TO SEE WHICH FIELD THAT YOU ARE TAKING THE DATA FROM
dim=['ga:pagetitle']
met=['ga:pageviews', 'ga:uniquePageviews', 'ga:avgTimeOnPage']
